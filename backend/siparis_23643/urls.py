"""siparis_23643 URL Configuration
...
admin.site.site_header = "siparis"
admin.site.site_title = "siparis Admin Portal"
admin.site.index_title = "siparis Admin"

# swagger
api_info = openapi.Info(
    title="siparis API",
    default_version="v1",
    description="API documentation for siparis App",
)
